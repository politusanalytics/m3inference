...
# Preprocessing
python scripts/download_images.py $path_to_input_json_file $path_to_output_image_folder $path_to_another_output_image_folder
python scripts/create_input_files.py $path_to_input_json_file $path_to_another_output_image_folder $path_to_output_folder
